...
func connectPostgres() *sql.DB {
	...
	// MANUAL MIGRATION
	// Karena tidak pakai GORM, kita harus buat tabel secara manual lewat SQL
	// Urutan pembuatan tabel PENTING karena Foreign Key
...
// 	log.Println("🔄 Menjalankan Manual Migration...")
...
// 			// Kita tidak panic disini agar jika tabel sudah ada, aplikasi tetap jalan (walau IF NOT EXISTS sudah menangani)
// 		}
// 	}
